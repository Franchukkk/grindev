        ...
        <div className="wrapper-md">
          <div className="items-center flex-between flex-wrap about-gap">
            <div className="about-description">
              <p>
              Працюємо з клієнтами як технічний партнер у проєкті, а не як виконавці окремих задач.
              </p>
              <p>
              Беремо повну відповідальність за архітектуру, розробку та стабільну роботу продукту.
              </p>
            </div>
