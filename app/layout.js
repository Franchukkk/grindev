...
export const metadata = {
  ...
  title: 'GRINDev | ідея → сайт: веб-розробка для росту бізнесу',
  description: 'Створюємо сайти, які працюють на ріст бізнесу, а не просто займають місце в інтернеті. Проєктуємо архітектуру з запасом на масштабування та роботу під навантаженням. Доводимо продукт до стану, коли він реально готовий працювати на результат.',
